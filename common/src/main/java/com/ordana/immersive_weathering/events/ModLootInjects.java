...
public class ModLootInjects {
    ...
    public static void onLootInject(RegHelper.LootInjectEvent event) {
        ...
        if (name.equals(ResourceLocation.withDefaultNamespace("chests/buried_treasure"))) {
            event.addTableReference(ImmersiveWeathering.res("injects/buried_treasure"));
        }
        if (name.equals(ResourceLocation.withDefaultNamespace("chests/shipwreck_supply"))) {
            event.addTableReference(ImmersiveWeathering.res("injects/shipwreck_supply"));
        }
        if (name.equals(ResourceLocation.withDefaultNamespace("chests/shipwreck_treasure"))) {
            event.addTableReference(ImmersiveWeathering.res("injects/shipwreck_treasure"));
        }
        if (name.equals(ResourceLocation.withDefaultNamespace("gameplay/hero_of_the_village/farmer_gift"))) {
            event.addTableReference(ImmersiveWeathering.res("injects/farmer_gift"));
        }
        if (name.equals(ResourceLocation.withDefaultNamespace("gameplay/hero_of_the_village/mason_gift"))) {
            event.addTableReference(ImmersiveWeathering.res("injects/mason_gift"));
        }
        if (name.equals(ResourceLocation.withDefaultNamespace("gameplay/hero_of_the_village/toolsmith_gift"))) {
            event.addTableReference(ImmersiveWeathering.res("injects/toolsmith_gift"));
        }
        if (name.equals(ResourceLocation.withDefaultNamespace("gameplay/hero_of_the_village/weaponsmith_gift"))) {
