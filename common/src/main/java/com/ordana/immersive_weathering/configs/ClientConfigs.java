...
public class ClientConfigs {
    ...
    public static void init() {
        ...
        FALLING_LEAF_PARTICLE_RATE = builder.define("falling_leaf_rate", 0.08, 0f, 1f);
        RAINY_FALLING_LEAF_PARTICLE_RATE = builder.define("rainy_falling_leaf_rate", 0.2, 0f, 1f);
        STORMY_FALLING_LEAF_PARTICLE_RATE = builder.define("stormy_falling_leaf_rate", 0.4, 0f, 1f);
        builder.pop();
